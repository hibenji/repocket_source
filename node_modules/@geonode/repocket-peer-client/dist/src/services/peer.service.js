...
class PeerService {
    constructor(options) {
        ...
        this.EVENTS_NAMES = {
            ...
            peer_server_502_error: 'peer_server_502_error',
        };
        ...
        this.connectivityNoneTimer = null;
        ...
        this.cachedPeerActivatedEver = null;
    ...
    async createPeer() {
        ...
        try {
            ...
            if (error?.status === 502) {
                this.events.emit(this.EVENTS_NAMES.peer_server_502_error);
            }
            return false;
        }
    }
    ...
    async _markPeerAsAlive() {
        try {
            ...
            console.error(`_markPeerAsAlive -> Error happened: ${error?.data}`);
            // if (error.status === 403) {
            //   this.events.emit(this.EVENTS_NAMES.refresh_token_required);
            // }
        }
